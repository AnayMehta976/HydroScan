...
export default function HydroScanWebsite() {
  const [page, setPage] = useState<"home" | "innovation" | "business" | "team">("home");
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <section className="px-8 py-32 bg-gradient-to-b from-black to-slate-900">
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
            <Card className="bg-slate-800/90 border border-white/10">
              <CardContent className="p-8">
                <DollarSign className="w-8 h-8 text-cyan-400 mb-4" />
                <h3 className="text-2xl font-semibold mb-4">Cost Structure</h3>
                <p className="text-slate-300">
                  Single-unit build cost is approximately ₹8,000, covering electronics,
                  optics, processing hardware, and enclosure.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/90 border border-white/10">
              <CardContent className="p-8">
                ...
                <p className="text-slate-300">
                  Target selling price of ₹12,000 per unit ensures affordability
            ...
            <Card className="bg-slate-800/90 border border-white/10">
              <CardContent className="p-8">
                ...
                <p className="text-slate-300">
                  Estimated profit margin of just over 30% per unit based on
        ...
        <footer className="px-8 py-16 text-center text-slate-400">
    ...
    return (
      <div className="min-h-screen bg-black text-white">
        <section className="px-8 py-32 text-center">
          ...
          <h1 className="text-5xl font-bold mb-8">The Team</h1>
        ...
        <section className="px-8 py-32">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
            <div className="p-8 bg-slate-800/90 rounded-xl border border-white/10">
              <h3 className="text-2xl text-cyan-400 mb-3">Anay Mehta</h3>
              <p className="text-slate-300">
                Co-founder focusing on optics, engineering, and machine learning,
                designing the optical system and on-device intelligence.
              </p>
            </div>

            <div className="p-8 bg-slate-800/90 rounded-xl border border-white/10">
              <h3 className="text-2xl text-cyan-400 mb-3">Yuvraj</h3>
              <p className="text-slate-300">
                Co-founder leading hardware integration and system design,
                translating the concept into a field-ready prototype.
              </p>
            </div>
          </div>
        </section>
    ...
    <section className="max-w-5xl mx-auto px-6 pb-20">
      ...
      <div className="grid md:grid-cols-2 gap-8 text-lg">
        <div className="p-8 rounded-xl bg-slate-800/90 backdrop-blur-xl shadow-xl border border-white/10">
          <h3 className="text-xl font-semibold mb-3">Human Health Impacts</h3>
        ...
        <div className="p-8 rounded-xl bg-slate-800/90 backdrop-blur-xl shadow-xl border border-white/10">
          <h3 className="text-xl font-semibold mb-3">Environmental Impacts</h3>
          <ul className="list-disc list-inside text-gray-300 space-y-2">
    ...
    <section className="max-w-5xl mx-auto px-6 py-20">
      ...
      <div className="space-y-6 text-lg">
        <div className="p-6 rounded-xl bg-green-500/10 border border-green-500">
          <p className="text-green-400 font-semibold">Low Contamination</p>
        ...
        <div className="p-6 rounded-xl bg-yellow-500/10 border border-yellow-500">
          <p className="text-yellow-400 font-semibold">Medium Contamination</p>
          <p className="text-white">
        ...
        <div className="p-6 rounded-xl bg-red-500/10 border border-red-500">
          <p className="text-red-400 font-semibold">High Contamination</p>
          <p className="text-white">
    ...
    <section className="px-8 py-32 bg-black">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          <Card className="bg-slate-800/90 backdrop-blur-xl border border-white/10">
            <CardContent className="p-8">
